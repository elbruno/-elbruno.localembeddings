...
- [ ] Create `samples/DocumentRagFoundry/README.md`
  - Setup instructions (download sample PDFs + images)
...
- [ ] Provide 2 sample PDFs (document1.pdf, document2.pdf)
- [ ] Provide 2 sample images (image1.jpg, image2.jpg)
